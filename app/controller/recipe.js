...
const recipeController = {
    ...
    getAllRecipe: async (_, res) =>{
        const recipe = await Recipe.findAll({ include: [ 'recipeTag', 'recipeIngredient', 'recipeStep', 'recipeQuantity' ], order: [ ['id', 'ASC'], ['recipeTag', 'label', 'ASC'], ['recipeIngredient', 'label', 'ASC'] ] });
